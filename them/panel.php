...
<head>
  ...
  <script type="text/javascript" src="/asset/js/date/jalali-moment.browser.js"></script>
  ...
  <script type="text/javascript" src="/asset/js/plugins/pickers/location/typeahead_addresspicker.js"></script>
  <script type="text/javascript" src="/asset/js/plugins/pickers/location/autocomplete_addresspicker.js"></script>
  <script type="text/javascript" src="/asset/js/plugins/pickers/location/location.js"></script>
  <script type="text/javascript" src="/asset/js/plugins/ui/prism.min.js"></script>
  <script type="text/javascript" src="/asset/js/pages/picker_location.js"></script>
...
<div class="navbar navbar-inverse">
  <div class="navbar-header">
    <a class="navbar-brand" href="index.html"><img src="/asset/image/logo/logo_light.png" alt=""></a>
    ...
    <ul class="nav navbar-nav navbar-right">
          ...
          <ul class="media-list dropdown-content-body">
            <li class="media">
              <div class="media-left">
                <img src="/asset/image/logo/placeholder.jpg" class="img-circle img-sm" alt="">
            ...
            <li class="media">
              <div class="media-left"><img src="/asset/image/logo/placeholder.jpg" class="img-circle img-sm" alt=""></div>
              <div class="media-body">
                <a href="#" class="media-heading">
      ...
      <li class="dropdown dropdown-user">
        <a class="dropdown-toggle" data-toggle="dropdown">
          <img src="/asset/image/logo/placeholder.jpg" alt="">
          <span><?php if (!isGuest()) {
              echo $_SESSION['email'];
            } ?></span>
          <i class="caret"></i>
        ...
        <ul class="dropdown-menu dropdown-menu-right">
          ...
          <li><a href="#"><i class="icon-coins"></i> مدیریت مالی</a></li>
          <li><a href="#"><span class="badge bg-teal-400 pull-right">58</span> <i class="icon-comment-discussion"></i>
              پیام ها </a></li>
          <li class="divider"></li>
          <li><a href="#"><i class="icon-cog5"></i> تنظیمات کاربری</a></li>
          <li><?php if (!isGuest()) {
              echo "<a href='/userCommon/logout'><span class='p-3'><i class='icon-switch2' style='margin-left: 10px;'></i>خروج از حساب</span></a>";
            } ?>
          </li>
        </ul>
      </li>
