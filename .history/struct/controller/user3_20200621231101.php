...
class User3Controller {
  ...
  function registerWorkShop() {
    ...
    $topicWorkshop = $_POST['topicWorkshop'];
    $employerWorkshop = $_POST['employerWorkshop'];
    ...
    if ($record == null) {
      ...
      message('fail', $data, true);
        ...
        User3Model::insertWorkshop($user_id, $nameCourse, $topicWorkshop, $employerWorkshop, $nameTeacher, $idTeacher, $type, $location, $durationCourse, $feeCourse, $startRegisterTime, $startRegisterDate, $endRegisterTime, $endRegisterDate, $capacityCourse, $startTime, $startDate, $endTime, $endDate, $moreExplain, $active);
        $response['Status'] = true;
        $response['ResultData']['code'] = 200;
