                ...
                <div class="panel panel-flat">
                  ...
                  <div class="panel-body">
                    ...
                    <div class="form-control-feedback">
                        ...
                        <select data-placeholder="موضوع" multiple="" id="counselingTopicIpt" class="select select2-hidden-accessible"
                  ...
                  <div class="form-group" id="frmEmployer">
                      <div class="form-control-feedback">
                        ...
                        <div class="has-feedback has-feedback-left">
                          <select data-placeholder="کارفرما" multiple="" id="lstEmployer" class="select select2-hidden-accessible"
                            tabindex="-1" aria-hidden="true">
...
<script>
  ...
  function formCoachValidation() {
    ...
    if ($("#formSelectTeacherType").find("input[type='radio']:checked").attr('id') == 'registeredTeacher'){
      ...
      var unRegisteredTeacherTxt = $('#iptUnregisteredTeacher').text();
      printOk('#lblSelectTeacherType', '');
      if (unRegisteredTeacherTxt == null){
    ...
    status = true;
    if (iptNameTeacher.length <= 2 && iptNameTeacher.length >= 30) {
      printError('#lblNameTeacher', 'نام وارد شده صحیح نیست');
      status = false;
    } else if (iptNameTeacher.length == 0) {
      printError('#lblNameTeacher', 'لطفا نام مدرس دوره را وارد کنید');
      status = false;
    } else {
      printOk('#lblNameTeacher', '');
    }
