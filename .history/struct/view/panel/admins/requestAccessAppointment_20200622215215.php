          ...
          <div class="panel panel-flat">
            <div class="navbar-collapse collapse" id="navbar-filter">
              <ul class="nav navbar-nav">
                <li class="active"><a href="requestAccessAppointment" aria-expanded="false" style="color: black;"><i class=" icon-calculator2 position-left"></i>دسترسی به نوبت ها</a></li>
                <li class=""><a href="requestAccessWorkshop" aria-expanded="false" style="color: black;"><i class="icon-wrench position-left"></i> دسترسی به کارگاه ها</a></li>
              </ul>
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
              <div class="panel panel-flat">
                <div class="panel-heading">
                  <h5 class="panel-title">درخواست دسترسی به نوبت ها <a class="heading-elements-toggle"><i
                        class="icon-more"></i></a>
                  </h5>
                ...
                <div class="panel-body">
                  <form name="formManager">
                    <div class="form-group">
                      ...
                      <br>
                      <span class="help-block"></span>لطفا نوع درخواست را انتخاب کنید:</span>
                      <div class="row">
                        <div class="col-md-3">
                          <select 
                            name="accessCate"
                            ...
                            class="form-control"
                          >
                            <option value="0" selected disabled>نوع درخواست را انتخاب کنید</option>
                            <option value="1">نوبت</option>
