          ...
          <div class="panel panel-flat">
            <div class="navbar-collapse collapse" id="navbar-filter">
              <ul class="nav navbar-nav">
                <li class="active"><a href="setting" aria-expanded="false"><i class=" icon-portfolio position-left"></i>دسترسی به نوبت ها</a></li>
                <li class=""><a href="treatmentApproach" aria-expanded="false"><i class="icon-grid5 position-left"></i> دسترسی به کارگاه ها</a></li>
              </ul>
            </div>
          </div>
          <div class="row">
