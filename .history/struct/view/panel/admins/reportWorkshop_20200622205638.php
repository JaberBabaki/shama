								...
								<div class="panel panel-white">
									...
									<div class="panel-body">
										<form action="#">
											...
											<form class="form-group">
												<div class="checkbox">
													<label class="display-block">
														<div class=""><span><input type="checkbox" class="checkbox" name="whichType" value="0"></span></div>
														دوره همگانی
													</label>
												</div>
												<div class="checkbox">
													<label class="display-block">
														<div><span><input type="checkbox" class="styled" name="whichType" value="1"></span></div>
											...
											<button type="submit" class="btn bg-blue btn-block" onclick="search()">
												<i class="icon-search4 text-size-base position-left"></i>
												گزارش گیری
											</button>
										</form>
