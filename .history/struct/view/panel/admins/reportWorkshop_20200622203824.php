									...
									<div class="panel-body">
										<form action="#">
											...
											<div class="form-control-feedback">
												...
												<div class="has-feedback has-feedback-left">
												<select data-placeholder="کارفرما" multiple="" id="searchBarTreatmentApproach" class="select select2-hidden-accessible"
													tabindex="-1" aria-hidden="true">
											...
											<div class="form-control-feedback">
												...
												<div class="has-feedback has-feedback-left">
												<select data-placeholder="مرجع اعطای پروانه" multiple="" id="searchBarSubTopic" class="select sele\ct2-hidden-accessible"
													tabindex="-1" aria-hidden="true">
