        ...
        <div class="sidebar-category sidebar-category-visible">
          <div class="category-content no-padding">
            <ul class="navigation navigation-main navigation-accordion">
              ...
              <li class=""><a href='/user4/dashboard'><i class="icon-home4"></i> <span>داشبورد</span></a>
              </li>
              <li class="active"><a href="informationPsych"><i class="icon-people"></i> <span>اطلاعات کاربری درمانگر</span></a></li>
              ...
              <div class="panel panel-flat">
                ...
                <div class="panel-body">
                  <form name="formPsych">
                    ...
                    <div class="form-group form-group-material">
                      <span class="help-block"> مجوز نظام روانشناسی را در بخش زیر وارد کنید:</span>
                    ...
                    <div style="margin-right: 15px">
                      <div class="form-group">
                        <label class="display-block">تعیین به عنوان مدرس کارگاه:</label>

                        <form id="radioTeacher">
                          <input class="radio-inline" type="radio" name="teacher" value="1"> بله
                          <input class="radio-inline" type="radio" name="teacher" value="0"> خیر
                        </form>
                      </div>
                      <label style="display: none;font-size: 12px" id="lblTeacher"
                             class="validation-error-label"> </label>
                    </div>
  ...
  <script>
    ...
    function formPsychValidation() {
      ...
      if (teacher == '0' || teacher == '1') {
        ...
        printError('#lblTeacher', 'لطفا بله یا خیر را انتخاب کنید');
        okTeacher = 1;
      }
      ...
      if (okCity == 0 && okOstan == 0 && okNamePsych == 0 && okGender == 0 && okTeacher == 0 && okPic == 0 && okEmail == 0 && okPhone == 0 && okNationalCode == 0 && okLicense == 0) {
        ...
        formDataPsych.append('teacher', teacher);
