(function ( $ ) {
    ...
    function GMapContext(domElement, options) {
        ...
        var _marker = new google.maps.Marker({
            position: new google.maps.LatLng(36.61488590389821, 52.85752521547814),
            map: _map,
            title: "Drag Me",
    ...
    $.fn.locationpicker = function( options, params ) {
        ...
        return this.each(function() {
            ...
            var gmapContext = new GMapContext(this, {
                zoom: settings.zoom,
              center: {lat: 36.61488590389821, lng: 52.85752521547814},
    ...
    $.fn.locationpicker.defaults = {
        location:{lat: 36.61488590389821, lng: 52.85752521547814},
      center: {lat: 36.61488590389821, lng: 52.85752521547814},
        locationName: "",
        radius: 500,
        zoom: 15,
