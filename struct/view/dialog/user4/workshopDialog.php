...
var workshop_id;
function runWorkshopDialog(_workshop_id){
    var formData = new FormData();
    var jsonData;
    workshop_id = _workshop_id;
    formData.append('workshop_id', workshop_id);
    $.ajax({
      url: baseURL+'/mangeCounseling/workshopInfo',
      type: 'POST',
      dataType: 'JSON',
      data: formData,
      contentType: false,
...
//   weekDay[6] = "شنبه";
  ...
  $("#appointmentText").html("<div>"+'اطلاعات دروه'+"</div>"+"<div>"+"نام دوره: "+courseName+"</div>"+"<div>"+"نام مدرس: "+teacherName+"</div>");
  ...
  $('#payment').click(function(){
    ...
    $.ajax({
      url: baseURL+'/user1/bookWorkshop',
      type: 'POST',
      dataType: 'JSON',
      data: formData,
      contentType: false,
