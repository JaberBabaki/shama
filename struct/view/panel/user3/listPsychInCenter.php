              ...
              <style>
                ...
                <?php for ($i=0; $i<count($regPsychs); $i++):?>
                  ...
                  <tr role="row" >
                    ...
                    <td style="text-align: center;"><?=$regPsychs[$i]['dateFrom']?>  تا  <?=$regPsychs[$i]['dateTo']?></td>
                    <td style="text-align: center;">
                      <?php
                        $tmpArray = explode(',', $regPsychs[$i]["days"]);
                    ...
                    <td style="text-align: center;"><?=$regPsychs[$i]["timeStart"]?><br> تا <br><?=$regPsychs[$i]["timeEnd"]?></td>
