                ...
                <div class="panel panel-flat">
                  ...
                  <div class="panel-body">
                    <form name="formCoach">
                      ...
                      <div class="form-group form-group-material">
                        <input type="text" name="edtNameCourse" class="form-control" id="iptNameTeacher" placeholder="نام مدرس دوره">
                        <label style="display: none;font-size: 12px" id="lblNameTeacher"
                               class="validation-error-label"> </label>
                      </div>
                      <div class="form-group form-group-material">
                    ...
                    <label style="display: none;font-size: 12px" id="lblOstanFounder"
                      ...
                      <div class="form-group form-group-material">
                        ...
                        <div class="checkbox">
                          <label>
                            <input type="checkbox" name="chkPsychology" id='checkBox'>
                            فعال
                          </label>
                        </div>
                      </div>
