...
<link href="/asset/css/colors.css" rel="stylesheet" type="text/css">
  ...
  <div class="page-container">
    <div class="page-content">
      ...
      <div class="sidebar sidebar-main sidebar-default" style="background-color: #C4C4C4 ">
                ...
                <?php endif;?>
						...
						<ul class="navigation ">
							...
							<li class=""><a href="<?php echo baseUrl(); ?>/user1/passedAppointments" class="text-right"><span>نوبت های حضور نیافته</span></a></li>
							<li class="active"><a href="<?php echo baseUrl(); ?>/user1/canceledAppointments" class="text-right"><span>نوبت های لغو شده</span></a></li>
      ...
      <div class="col-md-5">
      <?php if($canceledAppointments == null): ?>
      ...
      <div class="content-wrapper">
          ...
          <div class="table-responsive">
            <?php if($canceledAppointments!=null): ?>
              <table class="table text-nowrap table-striped border table-hover table-condensed">
                <tbody>
                  ...
                  <?php for ($i=0; $i<count($canceledAppointments); $i++): ?>
                    <tr>
                      <td>
                        <div class="media-right">
                          <a href="#"><img src="/asset/image/per-pic/<?=$canceledAppointments[$i]['psychPhoto']?>" class="img-circle" alt="" style="height: 80px; width: 80px"></a>
                        </div>
                        <div class="media-left position">
                          <div class=""><a href="#" class="text-default text-semibold">دکتر <?=$canceledAppointments[$i]['psychName']?></a></div>
                          <div class="text-muted text-size-small">
                          <?=stringConverter($canceledAppointments[$i]['endTime'], 'enToFa')?> - <?=stringConverter($canceledAppointments[$i]['startTime'], 'enToFa')?> 
                          </div>
                        </div>
                      </td>
                      <td>
                        <div class="text-default text-semibold position">درمانگاه <?=$canceledAppointments[$i]['counselingName']?></div>
                      </td>
                      <td>
                        <div class="media-left position">
                          <div class="text-default text-semibold text-center"><?=dayNumToDayNameConverter($canceledAppointments[$i]['day']) ?></div>
                          <div class="text-muted text-size-small">
                            <?=dateConverter($canceledAppointments[$i]['date'], 'enToFa') ?>
                          </div>
                        </div>
                      </td>
                      <td><div class="text-default text-semibold position">
                        <?php if($canceledAppointments[$i]['paymentMode']==1): ?>
                          پرداخت در محل
                        <?php endif; ?>
                        <?php if($canceledAppointments[$i]['paymentMode']==2): ?>
                          پرداخت آنلاین - در انتظار برگشت وجه
                        <?php endif; ?>
                      </div></td>
                    </tr>
                  <?php endfor; ?>    
            ...
            <?php endif; ?>
            <?php if($canceledAppointments==null): ?>
              <h3>نوبت لغو شده ایی وجود ندارد</h3>
            <?php endif; ?>
          </table>
        </div>
