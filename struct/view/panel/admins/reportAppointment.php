...
<div class="page-container">
        ...
        <div class="sidebar-category sidebar-category-visible">
          <div class="category-content no-padding">
            <ul class="navigation navigation-main navigation-accordion">
				...
				<li class="active"><a href="reportAppointment"><i class="icon-pencil7"></i> <span>گزارش گیری نوبت ها</span></a></li>
				...
				<div class="page-header page-header-default">
					<div class="page-header-content">
						<div class="page-title">
							<h4><i class="icon-arrow-right6 position-left"></i> <span class="text-semibold">گزارش گیری نوبت ها</span></h4>
					...
					<div class="breadcrumb-line"><a class="breadcrumb-elements-toggle"><i class="icon-menu-open"></i></a>
						<ul class="breadcrumb">
							...
							<li class="active">گزارش گیری نوبت ها</li>
						</ul>
									...
									<div class="panel-body">
										<form action="#">
											...
											<div class="form-control-feedback">
												...
												<select data-placeholder="موضوع مشاوره" multiple="" id="searchBarCouselingTopic" class="select select2-hidden-accessible"
													tabindex="-1" aria-hidden="true">
													<?php if(UserCommonController::listCounselingCategories() == null ): ?>
											...
											<div class="form-control-feedback">
												...
												<div class="has-feedback has-feedback-left">
												<select data-placeholder="رویکرد درمانی" multiple="" id="searchBarTreatmentApproach" class="select select2-hidden-accessible"
													tabindex="-1" aria-hidden="true">
													<?php if(UserCommonController::listTreatmentApproach() == null ): ?>
											...
											<div class="form-control-feedback">
												...
												<div class="has-feedback has-feedback-left">
												<select data-placeholder="موضوع فرعی" multiple="" id="searchBarSubTopic" class="select sele\ct2-hidden-accessible"
													tabindex="-1" aria-hidden="true">
													<?php if(UserCommonController::listSubTopic() == null ): ?>
														<option value="0">موضوعی تعریف نشده است</option>
													<?php endif; ?>
														<?php if (UserCommonController::listSubTopic() != null ): ?> 
											...
											<form id="radioGenderManager">
												<input class="checkbox-inline" type="checkbox" name="gender" value="1"> مرد
												<input class="checkbox-inline" type="checkbox" name="gender" value="0"> زن
											</form>
											<br>
  ...
  <script>
    ...
    function formManagerValidation() {
		...
		// things = JSON.stringify(searchData);
		// formData.append('searchData', things); 
		// formData.append('searchData', things); 
    ...
    function createPDF() {
        ...
        win.document.write('<title>سامانه ملی ازدواج</title>');   // <title> FOR PDF HEADER.
