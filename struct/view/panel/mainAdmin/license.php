            ...
            <div class="row">
                <div class="navbar-collapse collapse" id="navbar-filter">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="license"  aria-expanded="false"><i class="icon-package position-left"></i> مرجع اعطای پروانه</a></li>
                    </ul>
                </div>
        </div>
      </div>
        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"><i class="icon-add position-left"></i>اضافه کردن مرجع اعطای پروانه<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                </div>
                <div class="panel-body">
                        <div class="form-group">
                            <label>مرجع اعطای پروانه</label>
        ...
        <div class="col-md-7">
                  ...
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="DataTables_Table_2" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">مرجع</th>
...
<script>
    ...
    function formvalidationAndSend(){
        ...
        if (validate == 1){
            formDataPsych.append('license', counselingTopic);
            $.ajax({
            url: '/mainAdmin/addLicense',
            type: 'POST',
            dataType: 'JSON',
            data: formDataPsych,
            contentType: false,
