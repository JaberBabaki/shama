            ...
            <div class="row">
                <div class="navbar-collapse collapse" id="navbar-filter">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="employer"  aria-expanded="false"><i class="icon-hat position-left"></i> کارفرما</a></li>
        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"><i class="icon-add position-left"></i>اضافه کردن کارفرما<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                </div>
                <div class="panel-body">
                        <div class="form-group">
                            <label>کارفرما</label>
                            <input id="counselingTopicIpt" type="text" class="form-control">
                        </div>
        ...
        <div class="col-md-7">
                  ...
                  <thead>
                    <tr role="row">
                      ...
                      <th class="sorting" tabindex="0" aria-controls="DataTables_Table_2" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending">کارفرما</th>
...
<script>
    ...
    function formvalidationAndSend(){
        var counselingTopic = $('#counselingTopicIpt').val();
        var formDataPsych = new FormData();
        var validate = 1;
        if (counselingTopic.length == 0) {
            printError('#lblCounselingTopic', 'لطفا کارفرما را وارد کنید');
            validate = 0;
        }  else {
            printOk('#lblCounselingTopic', '');
        }
        if (validate == 1){
            formDataPsych.append('employer', counselingTopic);
            $.ajax({
            url: '/mainAdmin/addEmployer',
            type: 'POST',
            dataType: 'JSON',
            data: formDataPsych,
            contentType: false,
