      ...
      <div class="navbar navbar-default navbar-xs content-group">
            <div class="row">
                ...
                <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="workshopTopic"  aria-expanded="false"><i class=" icon-file-plus position-left"></i> موضوع کارگاه</a></li>
        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"><i class="icon-add position-left"></i>اضافه کردن موضوع کارگاه<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                </div>
                <div class="panel-body">
                        <div class="form-group">
                            <label>موضوع کارگاه</label>
...
<script>
    ...
    function formvalidationAndSend(){
        ...
        if (counselingTopic.length == 0) {
            printError('#lblCounselingTopic', 'لطفا موضوع کارگاه را وارد کنید');
            validate = 0;
        }  else {
            printOk('#lblCounselingTopic', '');
        }
        if (validate == 1){
            formDataPsych.append('workshopTopic', counselingTopic);
            $.ajax({
            url: '/mainAdmin/addWorkshopTopic',
            type: 'POST',
            dataType: 'JSON',
            data: formDataPsych,
            contentType: false,
