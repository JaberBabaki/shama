        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"><i class="icon-add position-left"></i>اضافه کردن موضوع مشاوره<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                </div>
...
<script>
    ...
    function formvalidationAndSend(){
        ...
        if (validate == 1){
            formDataPsych.append('counselingTopic', counselingTopic);
            $.ajax({
            url: '/mainAdmin/addCounselingTopic',
            type: 'POST',
            dataType: 'JSON',
            data: formDataPsych,
            contentType: false,
