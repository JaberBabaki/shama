      ...
      <div class="navbar navbar-default navbar-xs content-group">
            <div class="row">
                ...
                <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="workshopTeacher"  aria-expanded="false"><i class="icon-user-plus position-left"></i> مدرس کارگاه</a></li>
        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"><i class="icon-add position-left"></i>اضافه کردن مدرس کارگاه<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                </div>
                ...
                <div class="form-group">
                    <div class="form-control-feedback">
                        ...
                        <select data-placeholder="مدرس" multiple="" id="counselingTopicIpt" class="select select2-hidden-accessible"
...
<script>
    ...
    function formvalidationAndSend(){
        var teacherId = $('#counselingTopicIpt').val();
        var formDataPsych = new FormData();
        var validate = 1;
        if (teacherId == null) {
            printError('#lblCounselingTopic', 'لطفا یک مدرس را انتخاب کنید');
            validate = 0;
        }  else {
            printOk('#lblCounselingTopic', '');
        }
        if (validate == 1){
            formDataPsych.append('teacherId', teacherId);
            $.ajax({
            url: '/mainAdmin/addTeacherOfWorkshop',
            type: 'POST',
            dataType: 'JSON',
            data: formDataPsych,
            contentType: false,
