      ...
      <div class="navbar navbar-default navbar-xs content-group">
            <div class="row">
                ...
                <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="subTopic"  aria-expanded="false"><i class="icon-git-merge position-left"></i> موضوع فرعی</a></li>
        ...
        <div class="col-md-5">
            ...
            <div class="panel panel-flat">
                <div class="panel-heading">
                    <h5 class="panel-title"><i class="icon-add position-left"></i>اضافه کردن موضوع فرعی<a class="heading-elements-toggle"><i class="icon-more"></i></a></h5>
                </div>
                <div class="panel-body">
                        <div class="form-group">
                            <label>موضوع فرعی</label>
...
<script>
    ...
    function formvalidationAndSend(){
        var subTopic = $('#counselingTopicIpt').val();
        var formDataPsych = new FormData();
        var validate = 1;
        if (subTopic.length == 0) {
            printError('#lblCounselingTopic', 'لطفا موضوع فرعی را وارد کنید');
            validate = 0;
        }  else {
            printOk('#lblCounselingTopic', '');
        }
        if (validate == 1){
            formDataPsych.append('subTopic', subTopic);
            $.ajax({
            url: '/mainAdmin/addSubTopic',
            type: 'POST',
            dataType: 'JSON',
            data: formDataPsych,
            contentType: false,
